 ...
 *  Copyright (c) 2000 by Dmitry Rusov.  All rights reserved.              *
 *                                                                         *
 *  You can contact the author at the following addresses:                 *
 *                                                                         *
 *  Dmitry Rusov       FidoNet     2:5090/94                               *
 *  Internet           E-Mail      rusov94@mail.ru                         *
 *                                                                         *
 ***************************************************************************/
...
#include ".\h\smapi\compiler.h"
#include ".\h\smapi\typedefs.h"
#include ".\h\smapi\progprot.h"
#include ".\h\smapi\msgapi.h"
...
int j;
char ibuff[256];
char version[5], version_num[] = "1.06";
...
global_msgid %= 0xffffffff;
  ...
  sprintf (version_str,"EchoStat. Version %s%s",version_num,version);
  ...
  if (argc < 2)
  {
    fprintf(stderr,"Usage:     ESTT <cfg>\n");
    fprintf(stderr,"Example:   ESTT my.cfg\n\n");
    exit(1);
  }
  ...
  for (i = 0; i < main_config->areas_count; i++)
  {
    ...
    fprintf(current_std,"\n This version written by Dmitry Rusov, 2:5090/94 at Nov 2000\n");
